...
if (filter_input(INPUT_GET, 'action') != NULL) {
	...
	switch (filter_input(INPUT_GET, 'action')) {
            ...
            case('details_facture'):
                    ...
                    break;
            //Affichage des factures group�es dans un tableau
            ...
            case('createFactureAutoDos'):
                    ...
                    break;
            //Recuperation des infos envoy�es par le formulaire de creation de prestation avec verification php et insertion dans la base de donnees
            case('insertPrestation'):
                    require_once("BDD/facture/administrateurs/prestation.php");
                    break;
            //Recuperation des infos envoy�es par le formulaire de modification de prestation avec verification php et modification/insertion dans la base de donnees
            ...
            case('updateModel'):
                    ...
                    break;
            //Recuperation des infos envoy�es par le formulaire de creation de modele avec verification php et insertion dans la base de donnees
            case('insertModel'):
                    require_once("BDD/facture/administrateurs/model.php");
                    break;
            //Recuperation des infos envoy�es par le formulaire de modification de modele avec verification php et modification/insertion dans la base de donnees
            case('changeModele'):
                    require_once("BDD/facture/administrateurs/model.php");
                    break;
            //Creation des diagrammes de statistiques
            case('createDiagram'):
                require_once("pages/statistiques/pChart/createDiagram.php");
                break;
