...
//variable de distinguition des factures group�s et celles individuelles
$disp=$_GET['dispa'];

$pdo=new SPDO();
/*
 * fonction de selection des beneficiaires des r�partitions
 */
		...
		<th scope="col">Honoraires</th>
				...
				<td><?php echo $fac_hono; ?></td>
           		...
           		<td><?php echo $fac_montant ?></td>       										 
                                   ...
                                   <!-- Requete aussi des lignes de factures li�s � la facture -->
                                    ...
                                    <!-- Requete aussi des lignes de factures li�s � la facture..->plus  -->
