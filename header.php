            ...
            <div id="sidebar-wrapper" class="container">     
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav sidebar-brand">
                        ...
                        <li class="text-center sidebar-brand"><a href="#societes-contacts"><i class="icon-briefcase fa fa-briefcase fa-2x icon-2x"></i><br>Soci√©t√©s/Contacts</a></li>
                        ...
                        <li class="dropdown text-center"><a href="#factures" class="dropdown-toggle" data-toggle="dropdown" title="Factures"><i class="icon-list-alt fa fa-list-alt fa-2x icon-2x"></i><br />Factures <b class="caret"></b></a>    
                            ...
                            <ul>
                                <li class="dropdown-header">GÈnÈration de ModËle</li>
                                <li><a href="index.php?action=createModel"><i class="icon-plus fa fa-plus"></i> Nouveau ModËle...</a></li>
                        	</ul>
                        </li>
            ...
            <div class="container">
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="text-center"><a href="#societes-contacts"><i class="icon-briefcase fa fa-briefcase fa-2x icon-2x"></i><br>Soci√©t√©s/Contacts</a></li>
